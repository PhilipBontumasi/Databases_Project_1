...
INSERT INTO bed (bed_number, patient_id, location, occupancy_status) VALUES
(1, 2, 'Common Market Hospital', 'Occupied'),
(2, NULL, 'Common Market Hospital', 'Available'),
(3, NULL, 'Orchard Community Hospital', 'Available'),
(4, NULL, 'Common Market Hospital', 'Available'),
(5, 19, 'Main Street Hospital', 'Occupied'),
(6, NULL, 'Orchard Community Hospital', 'Available'),
(7, NULL, 'Common Market Hospital', 'Available'),
(8, 4, 'Main Street Hospital', 'Occupied'),
(9, NULL, 'Main Street Hospital', 'Available'),
(10, NULL, 'Common Market Hospital', 'Available'),
(11, 15, 'Orchard Community Hospital', 'Occupied'),
(12, NULL, 'Old Creek Childrens Hospital', 'Available'),
(13, NULL, 'Main Street Hospital', 'Available'),
(14, NULL, 'Orchard Community Hospital', 'Available'),
(15, NULL, 'Old Creek Childrens Hospital', 'Available'),
(16, NULL, 'Main Street Hospital', 'Available'),
(17, 7, 'Common Market Hospital', 'Occupied'),
(18, NULL, 'Orchard Community Hospital', 'Available');
